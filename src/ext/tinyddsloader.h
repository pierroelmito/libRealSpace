...
DDSFile::DXGIFormat DDSFile::GetDXGIFormat(const PixelFormat& pf)
{
	if (pf.m_flags & uint32_t(PixelFormatFlagBits::RGB)) {
		...
		case 32:
			if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x00ff0000 && pf.m_ABitMask == 0xff000000) {
				return DXGIFormat::R8G8B8A8_UNorm;
			}
			if (pf.m_RBitMask == 0x00ff0000 && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x000000ff && pf.m_ABitMask == 0xff000000) {
				return DXGIFormat::B8G8R8A8_UNorm;
			}
			if (pf.m_RBitMask == 0x00ff0000 && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x000000ff && pf.m_ABitMask == 0x00000000) {
				return DXGIFormat::B8G8R8X8_UNorm;
			}

			if (pf.m_RBitMask == 0x0000ffff && pf.m_GBitMask == 0xffff0000 && pf.m_BBitMask == 0x00000000 && pf.m_ABitMask == 0x00000000) {
				return DXGIFormat::R16G16_UNorm;
			}

			if (pf.m_RBitMask == 0xffffffff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 && pf.m_ABitMask == 0x00000000) {
		...
		case 24:
			break;
		case 16:
			if (pf.m_RBitMask == 0x7c00 && pf.m_GBitMask == 0x03e0 && pf.m_BBitMask == 0x001f && pf.m_ABitMask == 0x8000) {
				return DXGIFormat::B5G5R5A1_UNorm;
			}
			if (pf.m_RBitMask == 0xf800 && pf.m_GBitMask == 0x07e0 && pf.m_BBitMask == 0x001f && pf.m_ABitMask == 0x0000) {
				return DXGIFormat::B5G6R5_UNorm;
			}

			if (pf.m_RBitMask == 0x0f00 && pf.m_GBitMask == 0x00f0 && pf.m_BBitMask == 0x000f && pf.m_ABitMask == 0xf000) {
		...
		if (8 == pf.m_bitCount) {
			if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 && pf.m_ABitMask == 0x00000000) {
				return DXGIFormat::R8_UNorm;
			}
			if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x00000000 && pf.m_ABitMask == 0x00000000) {
				return DXGIFormat::R8G8_UNorm;
			}
		}
		if (16 == pf.m_bitCount) {
			if (pf.m_RBitMask == 0x0000ffff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 && pf.m_ABitMask == 0x00000000) {
		...
		if (16 == pf.m_bitCount) {
			if (pf.m_RBitMask == 0x00ff && pf.m_GBitMask == 0xff00 && pf.m_BBitMask == 0x0000 && pf.m_ABitMask == 0x0000) {
...
{
	if (DXGIFormat::BC1_Typeless == m_format || DXGIFormat::BC1_UNorm == m_format || DXGIFormat::BC1_UNorm_SRGB == m_format) {
		FlipCompressedImageBC1(imageData);
		return true;
	} else if (DXGIFormat::BC2_Typeless == m_format || DXGIFormat::BC2_UNorm == m_format || DXGIFormat::BC2_UNorm_SRGB == m_format) {
		FlipCompressedImageBC2(imageData);
		return true;
	} else if (DXGIFormat::BC3_Typeless == m_format || DXGIFormat::BC3_UNorm == m_format || DXGIFormat::BC3_UNorm_SRGB == m_format) {
		FlipCompressedImageBC3(imageData);
		return true;
	} else if (DXGIFormat::BC4_Typeless == m_format || DXGIFormat::BC4_UNorm == m_format || DXGIFormat::BC4_SNorm == m_format) {
		FlipCompressedImageBC4(imageData);
		return true;
	} else if (DXGIFormat::BC5_Typeless == m_format || DXGIFormat::BC5_UNorm == m_format || DXGIFormat::BC5_SNorm == m_format) {
